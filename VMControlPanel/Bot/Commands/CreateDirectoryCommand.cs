...
namespace Bot.Commands
{
    public class CreateDirectoryCommand : MessageCommand
    {
        ...
        {
            Log.Information($"[{message!.Chat.FirstName} {message.Chat.LastName} #{message.Chat.Id}] execute CreateDirectoryCommand");
            ...
            else if (userState.StateName! == "input_create_directory_name")
            {
                ...
                var response = await RequestClient.Instance.CreateDirectoryAsync(dto);
