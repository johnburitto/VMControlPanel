...
- [x] <mark style="background: #BBFABBA6;">Написати метод отримання акаунтів користувача ✅ 2024-03-10</mark>
- [x] <mark style="background: #BBFABBA6;">Оновити роботу команди /start ✅ 2024-03-10</mark>
- [x] <mark style="background: #BBFABBA6;">Написати сервіс для хешування даних в Redis ✅ 2024-03-11</mark>
- [x] <mark style="background: #BBFABBA6;">Написати машину станів ✅ 2024-03-11</mark>
- [x] <mark style="background: #BBFABBA6;">Реалізувати команду входу в систему ✅ 2024-03-12</mark>
- [x] <mark style="background: #BBFABBA6;">Хешувати дані про те, що користувач увійшов у систему ✅ 2024-03-12</mark>
- [x] <mark style="background: #BBFABBA6;">Реалізувати команду реєстрації в системі ✅ 2024-03-12</mark>
